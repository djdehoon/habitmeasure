  ...
  return (
    <div className="absolute inset-0 flex min-h-0 min-w-0 flex-col px-0.5 pt-0 pb-0.5 sm:px-0.5 sm:pt-0.5 sm:pb-2">
      ...
      <div className="flex min-h-0 min-w-0 w-full flex-1 flex-col items-stretch justify-between pt-0.5 pb-0 sm:pt-2 sm:pb-1">
        <div className="order-3 flex min-w-0 shrink-0 flex-col items-stretch sm:order-1">
          <p className="mx-auto min-w-0 w-full max-w-[170px] break-words text-balance text-center text-xs font-normal text-slate-300 [overflow-wrap:anywhere] sm:text-sm">
            {template.template_name}
          </p>
          {lowerExtra}
        </div>

        <div className="order-2 w-full text-center sm:order-2">
          <span className="shrink-0 text-2xl leading-none">{template.icon}</span>
        </div>

        <span
          className="order-1 mt-0 shrink-0 self-center select-none text-xl leading-none sm:order-3 sm:mt-20 sm:text-2xl md:text-2xl lg:text-3xl"
          aria-hidden
        />
      </div>
    </div>
